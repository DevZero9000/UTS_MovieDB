...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.CardViewViewHolder > {
    ...
    public void onBindViewHolder(@NonNull CardViewViewHolder holder, int position) {
        ...
        Glide.with(context)
        .load(Const.IMG_URL + results.getPoster_path()).into(holder.img_poster);
...
//        });
    ...
    public class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewViewHolder(@NonNull View itemView) {
            ...
            lbl_release_date = itemView.findViewById(R.id.lbl_releasedates_card_upComing);
            cv = itemView.findViewById(R.id.cv_upComing);
        }
    }
}
